"""
Nura - Core Agents Prompt Helpers
Initializes PromptLoader for core agents templates.
"""
...
def get_core_prompt(name: str, is_system: bool = False) -> str:
    """Fetch prompt template by name"""
    return prompt_loader.get_template(name, is_system)


def render_core_prompt(name: str, variables: dict, is_system: bool = False) -> str:
